...
<?php echo $column_left; ?>
	...
	<div class="col-sm-8">
	  ...
	  <div class="cart">
		...
		<div class="review">
			<div>
				<img src="catalog/view/theme/theme390/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" />&nbsp;&nbsp;
				<div class="btn-rew">
	...
	<div class="box-product"> 
		<ul class="related-slider">
			...
			<?php if ($product['rating']) { ?>
				<img height="13" src="catalog/view/theme/theme390/image/stars-<?php echo $product['rating']; ?>.png" alt="<?php echo $product['reviews']; ?>" />
			<?php } ?>
			</div>
			</li>
			<?php } ?>
...
new AjaxUpload('#button-option-<?php echo $option['product_option_id']; ?>', {
	...
	onSubmit: function(file, extension) {
		$('#button-option-<?php echo $option['product_option_id']; ?>').after('<img src="catalog/view/theme/theme390/image/loading.gif" class="loading" style="padding-left: 5px;" />');
...
$('#button-review').bind('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#review-title').after('<div class="attention"><img src="catalog/view/theme/theme390/image/loading.gif" alt="" /> <?php echo $text_wait; ?></div>');
		},
		complete: function() {
