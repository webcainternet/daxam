        ...
        <div id="tab-data">
          <table class="form">
            ...
            <tr>
                ...
                <td><input type="text" name="price" value="<?php echo $price; ?>" /><select name="product_currency">
            ...
            <table id="option-value<?php echo $option_row; ?>" class="list">
              ...
              <tbody id="option-value-row<?php echo $option_value_row; ?>">
				...
				<select name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][price_prefix]">
                      ...
                      <option value="-">-</option>
                      <?php } ?>
                      <?php if ($product_option_value['price_prefix'] == 'z') { ?>
          ...
          <table id="discount" class="list">
            ...
            <tbody id="discount-row<?php echo $discount_row; ?>">
              <tr>
				...
				<input type="text" name="product_discount[<?php echo $discount_row; ?>][price]" value="<?php echo $product_discount['price']; ?>" /></td>
          ...
          <table id="special" class="list">
            ...
            <tbody id="special-row<?php echo $special_row; ?>">
              <tr>
				...
				<input type="text" name="product_special[<?php echo $special_row; ?>][price]" value="<?php echo $product_special['price']; ?>" /></td>
...
function addOptionValue(option_row) {	
	...
	html += '    <td class="right">';
				...
				<?php } ?>
				html += '</select>';
				html += '<select name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][price_prefix]">';
	html += '      <option value="+">+</option>';
	html += '      <option value="-">-</option>';
        html += '      <option value="z"> = </option>';
	html += '    </select>';
