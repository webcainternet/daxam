...
$('#button-account').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-account').after('<span class="wait">&nbsp;<img src="catalog/view/theme/theme390/image/loading.gif" alt="" /></span>');
		},		
		complete: function() {
...
$('#button-login').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-login').after('<span class="wait">&nbsp;<img src="catalog/view/theme/theme390/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
...
$('#button-register').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-register').after('<span class="wait">&nbsp;<img src="catalog/view/theme/theme390/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['warning']) {
					$('#payment-address .checkout-content').prepend('<div class="warning" style="display: none;">' + json['error']['warning'] + '<img src="catalog/view/theme/theme390/image/close-1.png" alt="" class="close" /></div>');
...
$('#button-payment-address').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-payment-address').after('<span class="wait">&nbsp;<img src="catalog/view/theme/theme390/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
...
$('#button-shipping-address').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-shipping-address').after('<span class="wait">&nbsp;<img src="catalog/view/theme/theme390/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['warning']) {
					$('#shipping-address .checkout-content').prepend('<div class="warning" style="display: none;">' + json['error']['warning'] + '<img src="catalog/view/theme/theme390/image/close-1.png" alt="" class="close" /></div>');
...
$('#button-guest').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-guest').after('<span class="wait">&nbsp;<img src="catalog/view/theme/theme390/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
...
$('#button-guest-shipping').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-guest-shipping').after('<span class="wait">&nbsp;<img src="catalog/view/theme/theme390/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
...
$('#button-shipping-method').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-shipping-method').after('<span class="wait">&nbsp;<img src="catalog/view/theme/theme390/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['warning']) {
					$('#shipping-method .checkout-content').prepend('<div class="warning" style="display: none;">' + json['error']['warning'] + '<img src="catalog/view/theme/theme390/image/close-1.png" alt="" class="close" /></div>');
...
$('#button-payment-method').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-payment-method').after('<span class="wait">&nbsp;<img src="catalog/view/theme/theme390/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['warning']) {
					$('#payment-method .checkout-content').prepend('<div class="warning" style="display: none;">' + json['error']['warning'] + '<img src="catalog/view/theme/theme390/image/close-1.png" alt="" class="close" /></div>');
