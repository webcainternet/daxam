<modification>
	<id>Fixed Price - OpenCart 1.5.1.x core file modifications</id>
	...
	<file name="catalog/model/catalog/product.php">
		<operation>
			<search position="replace"><![CDATA[$product_data = $this->cache->get('product.' . $cache . '.' . $customer_group_id);]]></search>
	<add><![CDATA[//$product_data = $this->cache->get('product.' . $cache . '.' . $customer_group_id);
