...
<script type="text/javascript" src="catalog/view/theme/<?php echo $this->config->get('config_template');?>/js/tm-stick-up.js"></script>
...
$.src="//v2.zopim.com/?327nQex2z6lVpCN0ClwhM9v40buyQss4";z.t=+new Date;$.
...
<div class="container">
<?php if (!empty($error)) { ?>
    <div class="warning"><?php echo $error ?><img src="catalog/view/theme/theme390/image/close-1.png" alt="" class="close" /></div>
<?php } ?>
