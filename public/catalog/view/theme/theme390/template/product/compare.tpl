  ...
  <table class="compare-info table table-bordered">
    ...
    <tbody>
      ...
      <tr>
        ...
        <?php foreach ($products as $product) { ?>
        <td><img src="catalog/view/theme/theme390/image/stars-<?php echo $products[$product['product_id']]['rating']; ?>.png" alt="<?php echo $products[$product['product_id']]['reviews']; ?>" /><br />
