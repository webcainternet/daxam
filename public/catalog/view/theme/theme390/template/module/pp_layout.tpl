<a href="<?php echo $payment_url; ?>" title="PayPal Express Checkout" style="text-decoration:none;">
    <?php if($is_mobile == true) { ?>
        <img src="catalog/view/theme/theme390/image/paypal_express_mobile.png" style="margin:10px; float:right;" alt="PayPal Express Checkout" title="PayPal Express Checkout" />
    <?php }else{ ?>
