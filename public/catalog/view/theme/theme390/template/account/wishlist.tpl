	...
	<div class="wishlist-product">
	  <div class="table-radius">
		...
		<tbody id="wishlist-row<?php echo $product['product_id']; ?>">
		  <tr>
			<td class="remove"><a href="<?php echo $product['remove']; ?>"><!--<img src="catalog/view/theme/theme390/image/remove.png" alt="<?php echo $button_remove; ?>" title="<?php echo $button_remove; ?>" />--><i class="fa fa-trash-o-o"></i></a></td>
