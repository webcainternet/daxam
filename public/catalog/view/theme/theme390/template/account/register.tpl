		...
		<div class="content">
		  <table class="form">
			<tr>
				...
				<td>
					<div class="form-group">
						<label class="control-label col-sm-5" for="telephone"><?php echo $entry_company; ?></label>
						<div class="controls col-sm-7">
			...
			<tr style="display: <?php echo (count($customer_groups) > 1 ? 'table-row' : 'none'); ?>;">
				<td>
					<div class="form-group">
						<label class="control-label col-sm-5" for="customer_group_id"><?php echo $entry_customer_group; ?></label>
						<div class="controls col-sm-7">
			...
			<tr id="company-id-display">
				<td>
					<div class="form-group">
						<label class="control-label col-sm-5" for="company_id"><span id="company-id-required" class="required">*</span> <?php echo $entry_company_id; ?></label>
						<div class="controls col-sm-7">
			...
			<tr id="tax-id-display">
				<td>
					<div class="form-group">
						<label class="control-label col-sm-5" for="tax_id"><span id="tax-id-required" class="required">*</span> <?php echo $entry_tax_id; ?></label>
						<div class="controls col-sm-7">
		...
		<div class="content">
		  <table class="form">
			<tr>
				<td>
					<div class="form-group">
						<label class="control-label col-sm-5" for="password"><span class="required">*</span> <?php echo $entry_password; ?></label>
						<div class="controls col-sm-7">
			...
			<tr>
				<td>
					<div class="form-group">
						<label class="control-label col-sm-5" for="confirm"><span class="required">*</span> <?php echo $entry_confirm; ?></label>
						<div class="controls col-sm-7">
