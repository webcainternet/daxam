    ...
    <div class="count-item">
      ...
      <div class="order-list">
        ...
        <div class="row">
          ...
          <div class="order-info col-sm-4"><a class="button" href="<?php echo $order['href']; ?>"><span><?php echo $button_view; ?></span></a>&nbsp;&nbsp;<a href="<?php echo $order['reorder']; ?>"><img src="catalog/view/theme/theme390/image/reorder.png" alt="<?php echo $button_reorder; ?>" title="<?php echo $button_reorder; ?>" /></a></div>
        </div>
        </div>
      </div>
      <?php } ?>
